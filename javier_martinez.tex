...
%\texttt{\small \url{http://martinezjavier.wordpress.com}}
%}
...
Software engineering, Linux user-space and kernel development, device drivers, Linux systems administration.
...
\item[January 2012 - Present] \emph{Software Engineer} - Collabora (\url{http://www.collabora.co.uk}): Open source consulting firm.

Working on improving the Desktop Bus (D-Bus) inter-process communication system.

Development of a new socket address family for the Linux platform.
...
Linux Kernel and bootloader (X-loader and U-boot) porting, customization and device drivers development for custom ARM OMAP3 (Cortex-A8) System-on-Chip boards. 
...
Teaching assistant for the course ``Electronic systems design based on microcontrollers''.
...
Kernel janitor with contributions to ARM architecture, usb, network, media and input subsystems.

Upstream maintainer of the Cypress TrueTouch Gen3 touchscreen driver. 
